...
1. Fork in GitHub https://github.com/atsign-foundation/at_pico_w
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_pico_w`)
3. Set your remotes as follows:

   ```sh
   cd at_pico_w
   git remote add upstream git@github.com:atsign-foundation/at_pico_w.git
   ...
   ```text
   origin  git@github.com:yourname/at_pico_w.git (fetch)
   origin  git@github.com:yourname/at_pico_w.git (push)
   upstream        git@github.com:atsign-foundation/at_pico_w.git (fetch)
